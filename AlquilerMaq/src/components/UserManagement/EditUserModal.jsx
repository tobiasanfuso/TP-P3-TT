...
const [form, setForm] = useState({ id: null, username: "", email: "", role: "" });
const [saving, setSaving] = useState(false);

useEffect(() => {
    if (userData) setForm({ id: userData.id, username: userData.username || "", email: userData.email || "", role: userData.role || "customer" });
